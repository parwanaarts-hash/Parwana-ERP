...
export default function SalesBillPage() {
  return (
    <PageShell 
      title="Sales Bill" 
      breadcrumb={["Stock","Sales","Bill"]}
    >
      <div className="flex-1 overflow-auto border-b" data-testid="container-grid-salesbillpage">
        <table className="w-full text-sm text-left whitespace-nowrap">
          <thead className="bg-muted/50 text-muted-foreground sticky top-0 z-10 shadow-sm">
            <tr>
              ...
              <th className="px-4 py-3 font-medium border-b">Bill Type</th>
              <th className="px-4 py-3 font-medium border-b">Cash</th>
              <th className="px-4 py-3 font-medium border-b">Bank</th>
              <th className="px-4 py-3 font-medium border-b">Total</th>
            </tr>
          </thead>
          <tbody>
            <tr>
      ...
      <div className="p-4 bg-muted/10 shrink-0 border-t" data-testid="container-form-salesbillpage">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-medium leading-none">Bill Reference</label>
