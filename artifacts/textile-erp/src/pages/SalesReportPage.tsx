...
export default function SalesReportPage() {
  return (
    <PageShell 
      ...
      breadcrumb={["Stock","Reports","Sales Register"]}
    >
      <div className="flex-1 overflow-auto border-b" data-testid="container-grid-salesreportpage">
      ...
      <div className="p-4 bg-muted/10 shrink-0 border-t text-center text-muted-foreground text-sm" data-testid="container-form-salesreportpage">
