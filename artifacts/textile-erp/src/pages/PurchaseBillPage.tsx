...
export default function PurchaseBillPage() {
  return (
    <PageShell 
      title="Purchase Bill" 
      breadcrumb={["Stock","Purchase","Bill"]}
    >
      <div className="flex-1 overflow-auto border-b" data-testid="container-grid-purchasebillpage">
        <table className="w-full text-sm text-left whitespace-nowrap">
          <thead className="bg-muted/50 text-muted-foreground sticky top-0 z-10 shadow-sm">
            <tr>
              ...
              <th className="px-4 py-3 font-medium border-b">Supplier Bill#</th>
      ...
      <div className="p-4 bg-muted/10 shrink-0 border-t" data-testid="container-form-purchasebillpage">
