...
export default function ReturnReportPage() {
  return (
    <PageShell 
      ...
      breadcrumb={["Stock","Reports","Return Register"]}
    >
      <div className="flex-1 overflow-auto border-b" data-testid="container-grid-returnreportpage">
      ...
      <div className="p-4 bg-muted/10 shrink-0 border-t text-center text-muted-foreground text-sm" data-testid="container-form-returnreportpage">
