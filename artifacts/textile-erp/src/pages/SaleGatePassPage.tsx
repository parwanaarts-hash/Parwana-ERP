  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans p-6">
      <div className="max-w-7xl mx-auto bg-white border border-gray-200 rounded-lg overflow-hidden">
        ...
        {/* ── GP records list ───────────────────────────────────────────────── */}
        <div className="mx-6 mt-4 border border-gray-200 rounded-lg overflow-hidden">
          <EntityTable
            columns={[
              ...
              },
              {
                ...
                render: (row: SaleGatePass) =>
                  row.shikanjaId != null
                    ? (shikanjaMap[row.shikanjaId] ?? `#${row.shikanjaId}`)
                    : "—",
              },
              {
                key: "items",
            ...
            emptyMessage="No sale gate passes found."
          />
        </div>
