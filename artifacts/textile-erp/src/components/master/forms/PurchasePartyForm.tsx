...
import { z } from "zod";
import { PurchasePartyInput } from "@workspace/api-client-react";
...
interface PurchasePartyFormProps {
  initialData?: Partial<PurchasePartyInput>;
  onSubmit: (data: PurchasePartyInput) => void;
}

export function PurchasePartyForm({ initialData, onSubmit }: PurchasePartyFormProps) {
  ...
  useEffect(() => {
    if (initialData) {
      ...
      form.reset({ name: "", phone: "", city: "", address: "", openingBalance: "" });
    }
  }, [initialData, form]);
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input {...field} data-testid="input-purchaseparty-name" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input {...field} data-testid="input-purchaseparty-phone" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input {...field} data-testid="input-purchaseparty-city" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="number" step="0.01" {...field} data-testid="input-purchaseparty-openingbalance" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
